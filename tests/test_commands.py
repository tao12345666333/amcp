...
class TestCommandManager:
    ...
    def test_discover_commands_from_dir(self, command_manager: CommandManager, temp_commands_dir: Path, sample_command_file: Path):
    ...
    def test_parse_command_file(self, command_manager: CommandManager, temp_commands_dir: Path, sample_command_file: Path):
    ...
    def test_namespaced_commands(self, command_manager: CommandManager, temp_commands_dir: Path, namespaced_command_file: Path):
