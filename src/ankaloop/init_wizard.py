"""Interactive initialization wizard for AnkaLoop configuration."""
...
def run_init_wizard() -> Path:
    ...
    console.print(
        Panel.fit(
            "[bold blue]AnkaLoop Configuration Wizard[/bold blue]\n\n"
            "This wizard will help you set up AnkaLoop with your preferred AI model provider.",
            title="Welcome",
        )
    )
    ...
    console.print("AnkaLoop can download a database of AI models from models.dev")
    ...
    config = AnkaloopConfig(servers=servers, chat=chat_config)
    ...
    console.print("\n[dim]Run 'anka' to start chatting![/dim]")
