"""Agent specification and resolution for AnkaLoop."""
...
def get_default_agent_spec(
    ...
    return ResolvedAgentSpec(
        name="default",
        description="Default AnkaLoop agent with template-based prompts",
...
def get_subagent_spec(
    ...
    return ResolvedAgentSpec(
        name=template_name,
        description=f"AnkaLoop {template_name} subagent",
