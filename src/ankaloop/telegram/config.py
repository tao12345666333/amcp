...
def apply_env_overrides(cfg: TelegramConfig | None) -> TelegramConfig | None:
    token = os.environ.get("ANKA_TELEGRAM_BOT_TOKEN")
    allowed = parse_user_ids(os.environ.get("ANKA_TELEGRAM_ALLOWED_USERS"))
    admin = parse_user_ids(os.environ.get("ANKA_TELEGRAM_ADMIN_USERS"))
