"""Session wrapper for AnkaLoop client.
...
class ClientSession:
    ...
    async def events(self) -> AsyncIterator[dict[str, Any]]:
        ...
        Note:
            This requires WebSocket support. Use AnkaloopClient.websocket_session()
            for event streaming.
        """
        # This is a placeholder - actual implementation would need
        # SSE or WebSocket support
        raise NotImplementedError("Event streaming requires WebSocket. Use AnkaloopClient.websocket_session()")
