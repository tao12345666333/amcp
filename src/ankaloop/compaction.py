"""
Smart Context Compaction for AnkaLoop.
...
Example:
    from ankaloop.compaction import SmartCompactor, get_model_context_window
...
class SmartCompactor:
    ...
    def __init__(
        ...
        Args:
            client: AnkaLoop LLM client for generating summaries
